...
public:
    ...
    // End of Functions |||||||||||||||||||||||||||||||||||||||||||
        ...
        Error newProcedureCall(TCLCommandsController::ProcedureCall::Name name);
    ...
    public:
        ...
        Command& readCommand(){return command;}
        inline Command printPredefinitions(){return predefinitionsController.getPredefinitionsStr();}
    ...
    friend class TCLCommandsController;
};
