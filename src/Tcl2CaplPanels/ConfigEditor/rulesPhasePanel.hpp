#ifndef RULEPHASEPANEL_HPP
#define RULEPHASEPANEL_HPP
...
#include"ModifierRulePanels/modifierRawRule.hpp"
...
namespace Panels::Configuration::View::ModifierRules::RulesPhasePanel{
    ...
    protected:
        ...
        QString phaseName_;
        ControllerConfigInfo::ModifierRulesCategories rulesCategory_ = static_cast<ControllerConfigInfo::ModifierRulesCategories>(LONG_LONG_MIN);
    public:
        inline QString& phaseName(){return phaseName_;}
        inline ControllerConfigInfo::ModifierRulesCategories& rulesCategory(){return rulesCategory_;}
        ...
        inline bool initialized()const{return rulesCategory_ != static_cast<ControllerConfigInfo::ModifierRulesCategories>(LONG_LONG_MIN);}
        inline void setNonInitialized(){rulesCategory_ = static_cast<ControllerConfigInfo::ModifierRulesCategories>(LONG_LONG_MIN);}
    ...
    public:
        ...
        inline QString& phaseName(){return rulesList.phaseName();}
        inline ControllerConfigInfo::ModifierRulesCategories& rulesCategory(){return rulesList.rulesCategory();}
