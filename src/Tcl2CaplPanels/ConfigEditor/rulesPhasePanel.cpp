...
using namespace Panels::Configuration::View::ModifierRules::RulesPhasePanel;
...
void RulesList::readRules(RulesRef& rules)
{
    ...
    for(int i = 0; i < rules.size(); i++, rule++){
        *rule = ModifierRulesFactory::create(ModifierRulesFactory::ProductTypeEnum::RawRule);
