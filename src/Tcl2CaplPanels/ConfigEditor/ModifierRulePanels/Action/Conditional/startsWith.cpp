...
using StartsWithActionView = ActionsList_NS::StartsWithActionView::StartsWithActionView;
using ListOfIndexes = StartsWithActionView::ListOfIndexes;
using ActionView = StartsWithActionView::ActionView;
using ParentContextMenu = StartsWithActionView::ParentContextMenu;

// CompareNumbOfArgs Action View Definitions -----------------------------------

StartsWithActionView::StartsWithActionView(QWidget* parent)
...
StartsWithActionView::StartsWithActionView(QWidget* parent, ActionPtr pAction)
    : StartsWithActionView(parent)
{
    if(pAction){
...
void StartsWithActionView::readAction(ActionBase& fAction){
...
StartsWithActionView::DataView* StartsWithActionView::create(QWidget* parent, ActionRef action){
    return new StartsWithActionView(parent, action);
}
