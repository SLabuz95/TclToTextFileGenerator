#ifndef MODIFIER_ACTION_PANEL_STARTSWITH_HPP
#define MODIFIER_ACTION_PANEL_STARTSWITH_HPP
...
namespace Panels::Configuration::View::ModifierActionsList::StartsWithActionView{

    class StartsWithActionView
            : public ActionDataView<ModifierActionsFactory::ListOfBases>
    {

        static constexpr ActionType actionType = ModifierActionTypes::StartsWith;
        ...
        StartsWithActionView(QWidget* );
        StartsWithActionView(QWidget* , ActionPtr);
    public:
...
#endif // MODIFIER_ACTION_PANEL_STARTSWITH_HPP
