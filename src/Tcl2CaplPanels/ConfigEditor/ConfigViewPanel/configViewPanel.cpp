...
void ConfigViewPanel::loadConfigData(QStringList& writeOnlyProcedures, ControllerConfigInfo::PhasesView& phasesView, ControllerConfigInfo::ProceduresView& proceduresView)
{
