...
namespace Panels::Configuration{
    ...
    namespace View{
        ...
        public:
            ...
            void loadConfigData(QStringList& writeOnlyProcedures, ControllerConfigInfo::Attributes& attributes,ControllerConfigInfo::PhasesView& phasesView, ControllerConfigInfo::ProceduresView& view);
        };
    }
